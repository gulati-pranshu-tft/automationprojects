...
public class ResourceExcelReader {
    ...
    public ResourceExcelReader(String resourceFileName) {

        this.resourceFileName = resourceFileName;
        try {
            fis = Thread.currentThread().getContextClassLoader().getResourceAsStream(this.resourceFileName);
